(function ($) {
    ...
    var totalPage = 0;
    exec = function () {
        $.getScript('http://query.china.com.cn/news/queryFn?index=en&fields=channel,url,subtitle,title&kws=1,vietnamese.china.org.cn,%E8%B6%8A%E5%8D%97%E6%96%87,' + searchText + '&pageSize=' + pageSize + '&startPage=' + startpage);
    };
    exec();
