(function ($) {
    ...
    var totalPage = 0;
    exec = function () {
        $.getScript('http://query.china.com.cn/news/queryFn?index=en&fields=channel,url,subtitle,title&kws=1,indonesian.china.org.cn,%E5%8D%B0%E5%B0%BC%E6%96%87,' + searchText + '&pageSize=' + pageSize + '&startPage=' + startpage);
    };
    exec();
